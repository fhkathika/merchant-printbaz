      ...
      <Nav className="my-2 my-lg-0" style={{width:"100%",height:"100%",display:"flex",justifyContent:"space-between" }} >
        <ul className="navbar-nav" style={{zIndex:"111"}}>
          <li className="nav-item" >
            <Link className="nav-link" style={{padding:"25px 10px"}} to="/dashboard">Dashboard</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" style={{padding:"25px 10px"}} to="/myorders">Order</Link>
          </li>
          {/* <li className="nav-item">
            <Link className="nav-link" to="/invoice">Invoice</Link>
          </li> */}
          <li className="nav-item">
            <Link className="nav-link" style={{padding:"25px 10px"}} to="/newOrdersWithOption">New Order</Link>
          </li>  
           {/* <li className="nav-item">
            <Link className="nav-link" to="/screenshot">Screenshots</Link>
          </li>  */}
            <li className="nav-item">
            <Link className="nav-link" style={{padding:"25px 10px"}} to="/ticket">Ticket</Link>
         {
     ...
     <span className='notification-badge' >{msgCount}</span>
        ...
        <div className="navbar-dropdown mt-2 dropdownMobile" >
          <button className="navbar-dropdown-toggle dropdownButtonMobile" onClick={handleDropdownClick} >
               ...
               <span  className="profile-text" style={{padding:"15px 0"}}>{user?.name}</span>
          ...
          {dropdownOpen && (
            <ul className="navbar-dropdown-menu dropdown-menu-mobile "  style={{zIndex:"132"}}>
              ...
              {user ? (
                <li onClick={handleLogOut} className="navbar-dropdown-item" style={{color:"#EA3A3B" ,marginTop:"6px",textDecoration:"none", padding:"10px"}}>
                  Log Out
                </li> 
              ) : (
