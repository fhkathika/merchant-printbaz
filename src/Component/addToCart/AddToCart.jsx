                      ...
                      {/* {item?.teshirtSize?.L && "L: " + item?.teshirtSize?.L}  
                       {item?.tshirtSize?.M && "M: " +  item?.tshirtSize?.M}  
                        ...
                        {item?.quantityXXXL&& "3XL: " + item?.quantityXXXL}       
                            ...
                            <td>
                              <button onClick={(e)=>deleteCartItem(selectedProduct?.uniqueId,e)} className="btn btn-primary btn-sm mr-2">Delete</button>
                              <button onClick={(e) => startEdit(e,selectedProduct?.uniqueId)} className="btn btn-primary btn-sm">Edit</button>
