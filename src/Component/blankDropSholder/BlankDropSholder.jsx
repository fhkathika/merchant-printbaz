...
<div className="alert-box" >
 ...
 <h3 className='m-4'  style={{cursor:"pointer"}} onClick={handleBack}> <img style={{width:"20px"}} src='/images/left-arrow.png' alter="backTocategory"/>   Blank Drop Sholder T-Shirt</h3>
