...
<div className="alert-box" >
 ...
 <h3 className='m-5'  style={{cursor:"pointer"}} onClick={handleBack}> <img style={{width:"20px"}} src='/images/left-arrow.png' alter="backTocategory"/>   Blank Hoodie</h3>
...
<Row xs={1} md={5} className="g-4 m-5">
